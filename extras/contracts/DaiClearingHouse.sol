...
contract Dach {
    TokenLike public constant dai =
        TokenLike(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    TokenLike public constant chai =
        TokenLike(0x06AF07097C9Eeb7fD685c692751D5C66dB49c215);
    Uniswappy public constant daiUniswap =
        Uniswappy(0x2a1530C4C41db0B0b2bB646CB5Eb1A67b7158667);
    Uniswappy public constant chaiUniswap =
        Uniswappy(0x6C3942B383bc3d0efd3F36eFa1CBE7C8E12C8A2B);
    ...
    bytes32 public constant DAICHEQUE_TYPEHASH =
    ...
    bytes32 public constant DAISWAP_TYPEHASH =
    ...
    bytes32 public constant CHAIJOIN_TYPEHASH =
    ...
    bytes32 public constant CHAICHEQUE_TYPEHASH =
    ...
    bytes32 public constant CHAISWAP_TYPEHASH =
    ...
    bytes32 public constant CHAIEXIT_TYPEHASH =
        0x69fa4cd566f89a9c8d4e3ca437a7fbc893137962cb1b036c59ceeb1415c58c01;

    constructor() public {
        dai.approve(address(chai), uint256(-1));
        dai.approve(address(daiUniswap), uint256(-1));
        chai.approve(address(chaiUniswap), uint256(-1));
    }
    ...
    function chaiSwap(
        ...
        chai.transferFrom(sender, relayer, fee);
        return
            chaiUniswap.tokenToEthTransferInput(amount, min_eth, now, sender);
    }
